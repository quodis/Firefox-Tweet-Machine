...
// Created: 7/16/2010 5:39:44 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcsvj81q5wz5bd3hm5k1vpmtq_7x7i";
	this.domain="statse.webtrendslive.com";
	this.timezone=0;
	this.fpcdom=".firefoxtweetmachine.com";
	this.onsitedoms="";
...
WebTrends.prototype.dcsGetId=function(){
    ...
    script_tag.src = "http" + (window.location.protocol.indexOf('https:')==0?'s':'') + "://" + this.domain + "/" + this.dcsid + "/wtid.js";
